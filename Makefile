TARFILES = Makefile scanner.mll parser.mly ast.mli check.ml checktype.mli expression.ml declaration.ml action.ml selection.ml start.ml statement.ml compile.ml next.ml

OBJS = parser.cmo scanner.cmo check.cmo expression.cmo declaration.cmo action.cmo selection.cmo start.cmo statement.cmo compile.cmo next.cmo 
LIBPATH = -I +sdl
